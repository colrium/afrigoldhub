...
const inputClassName = "w-full rounded bg-surface border border-primary/15 px-4 py-3 text-sm text-onSurface-100 outline-none transition focus:border-primary placeholder:text-onSurface-100/35";
...
export default function ContactForm({ className = "", ...props }: ContactFormProps) {
	...
	return (
		<form
			className={`max-w-295 mx-auto flex flex-col gap-12 rounded-lg border border-primary/20 bg-surface-900 p-6 md:p-8 ${className}`}
			{...props}
