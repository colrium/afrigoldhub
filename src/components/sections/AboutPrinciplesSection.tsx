...
export default function AboutPrinciplesSection() {
	...
	const items = t("about_page.principles.items", {
		returnObjects: true,
	}) as Principle[];
					...
					{items.map((item, index) => {
						...
						return (
							<FadeUp key={item.title} delay={index * 0.06}>
								<article className="h-full rounded-lg border border-[rgba(201,168,76,0.12)] bg-[#111111] p-6 transition-all hover:border-primary/45 hover:-translate-y-1">
